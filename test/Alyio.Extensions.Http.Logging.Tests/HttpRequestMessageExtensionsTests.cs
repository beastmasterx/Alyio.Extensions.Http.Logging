...
{
    private static readonly string[][] s_testHeaders = {
    ...
    [Theory]
    [MemberData(nameof(GetTestHeaders))]
    ...
    public static TheoryData<string[]> GetTestHeaders()
    {
        return new TheoryData<string[]>(s_testHeaders);
    }
}
